...
@section('content')
    ...
    <a class="btn btn-warning add m-2 rounded-4" href="{{ url('/produksi/tambah') }}" role="button">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8 d-flex justify-content-evenly">
                    <div class="card-body align-self-center">
                        ...
                        <p class="card-text text-body-secondary">Jumlah: {{ $product->quantity }} pcs</p>
                    </div>
                    <div class="card-body align-self-center">
                        <a class="nav-links float-end text-decoration-none"
                            href="{{ url('/produksi/hapus/' . $product->id) }}"
                            onclick="return confirm('Apa kamu yakin?')">Hapus</a>
                        <a class="nav-links float-end px-5 text-decoration-none"
                            href="{{ url('/produksi/edit/' . $product->id) }}">Edit</a>
                        <a class="nav-links float-end text-decoration-none"
                            href="{{ url('/produksi/detail/' . $product->id) }}">Detail</a>
                    </div>
                </div>
            </div>
        </div>
